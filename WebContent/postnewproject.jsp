...
$("#save").click(function(){
	...
	$("#chooseEmployee").click(function(){
	   ...
	   $("#newprojectform").attr("action", "chooseEmployeeServlet");
	   $("#newprojectform").submit();
	});
});
</script>
...
/*function formatDate(theForm) {
	  ...
	  theForm.startDate.value=year+'-'+month+'-'+day+' '+hour+':'+min+":00";
	  
	  alert(document.getElementByID('startDate'+id).value);
	  var year = theForm.year2.options[theForm.year2.selectedIndex].value;
	  var month = theForm.month2.options[theForm.month2.selectedIndex].value;
	  if (month.length=1) month='0'+month; 
	  var day = theForm.day2.options[theForm.day2.selectedIndex].value;
	  if (day.length=1) day='0'+day; 
	  var hour = theForm.hour2.options[theForm.hour2.selectedIndex].value;
	  if (hour.length=1) hour='0'+hour; 
	  var min = theForm.min2.options[theForm.min2.selectedIndex].value;
	  if (min.length=1) min='0'+min; 
	 theForm.endDate.value=year+'-'+month+'-'+day+' '+hour+':'+min+":00";
...
<b>You logged as <%=uname.getUsername()%></b><% }%><a onClick="location.href='logout'"><img alt="" src="images/logout.png" width="30" height="30" /></a>
	...
	<div id="content">
					...
					<form name="newprojectform" method="post" action="newproject" id="newprojectform">
						...
						<table>
							<tr>
								...
								<input class="loginform_text" name="code" id="code" type="text" value="${param.code}" style="width: 50px; height: 18px;" onclick="this.value='';" />
							...
							<tr>
								...
								<input class="loginform_text" name="title" id="title" type="text" value="${param.title}" style="width: 100px; height: 18px;" onclick="this.value='';" />
							...
							<tr>
								...
								<input class="loginform_text" name="status" id="status" type="text" value="Open" readonly="readonly" style="width: 100px; height: 18px;"  />
							...
							<tr>
								...
								<textarea name="description" id="description" cols="30" rows="10"  >${param.description}</textarea>
							...
							<tr>
								...
								<td><input class="loginform_text" name="goal" id="goal" type="text" value="0" style="width: 40px; height: 18px;" onclick="this.value='';" /><label><b>hours</b></label></td>
								</tr>
								<% counter++;
								} %>
								</table>
							...
							<tr>
								...
								<input name="save" type="submit" id="save" value="New Project" style="width: 100px; height: 20px;"/>
								</td>
