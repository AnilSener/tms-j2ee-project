...
<div id="top" >
	...
	HttpGet httpGet = new HttpGet(basePath+"/getMyEvaluations?employeeid="+uname.getId()+"&status=Submitted");
	...
	<h2>MY PERFORMANCE FEEDBACKS</h2>	
	<table border="1">
	<tr>
	<th>Employee</th>
	<th>Start Date</th>
	...
	<% for(int i=0 ; i <evaluationList.size() ; i ++){ 
		...
		/*DefaultHttpClient httpClient4 = new DefaultHttpClient();
	  	...
	  	httpClient4.close();*/
		String fullName=uname.getFirstname()+" "+uname.getLastname();
		
		//To retrieve supervisor employee
		DefaultHttpClient httpClient3 = new DefaultHttpClient();
	  	HttpGet httpGet3 = new HttpGet(basePath+"/getEmployeeByIDServlet?employeeID="+uname.getSupervisorId());
