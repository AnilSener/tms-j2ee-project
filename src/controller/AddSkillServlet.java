 ...
 */
@WebServlet(description = "Add JobSeeker Skill", urlPatterns = { "/addskill" })
public class AddSkillServlet extends DBConnectionServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dataManager.addSkillToJobSeeker(jobseekerID,skillID);
